...
import { findTomlSection, removeSetting } from "./toml-section-editor"
...
async function collectProjectLocalArtifacts(projectRoot: string): Promise<readonly ProjectLocalCodexArtifact[]> {
